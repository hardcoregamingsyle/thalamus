...
|---|---|---|
| Analyser | `reasoning` | The lead. Opens every run, analyses, and directs the team with over-to. Steps in only when a seat has refused the ending contract through the whole coached bound; naming nobody itself = run complete. |
