...
import {
  MessageSquare, Search, Code2, Plus, Trash2, LogOut, Terminal,
  Send, ChevronRight, Loader2, DollarSign, Menu, X, Users,
  Database, Cpu, Zap, Brain,
} from "lucide-react";
            ...
            {MODES.find(m => m.id === activeMode) && (() => {
              ...
              return (
                <>
                  ...
                  <span className={`text-xs font-bold ${m.color}`}>{m.label}_MODE</span>
