...
export class VMLauncher {
  ...
  /** Installer URL — one-time setup that installs everything (v6.22.0) */
  static readonly INSTALLER_URL = "https://github.com/hardcoregamingsyle/thalamus/releases/download/vm-installer-v6.22.0/thalamus-installer-v6.22.0.exe";
  /** Bridge URL — the bridge exe itself (for manual install) */
  static readonly BRIDGE_URL = "https://github.com/hardcoregamingsyle/thalamus/releases/download/vm-bridge-v3.3.0/thalamus-vm-bridge-v3.3.0.exe";
