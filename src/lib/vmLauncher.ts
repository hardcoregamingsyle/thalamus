...
export class VMLauncher {
  ...
  /** Installer URL — one-time setup that installs everything (v4.3.0) */
  static readonly INSTALLER_URL = "https://github.com/hardcoregamingsyle/thalamus/releases/download/vm-installer-v4.3.0/thalamus-installer-v4.3.0.exe";
