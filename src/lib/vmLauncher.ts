...
export class VMLauncher {
  ...
  /** Installer URL — one-time setup that installs everything (v6.14.0) */
  static readonly INSTALLER_URL = "https://github.com/hardcoregamingsyle/thalamus/releases/download/vm-installer-v6.14.0/thalamus-installer-v6.14.0.exe";
