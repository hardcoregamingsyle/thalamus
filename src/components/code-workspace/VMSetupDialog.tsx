                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <Button asChild size="sm" className="gap-2 w-full">
                        <a href="https://github.com/hardcoregamingsyle/thalamus/releases/download/vm-installer-v4.3.0/thalamus-installer-v4.3.0.exe" target="_blank" rel="noopener noreferrer">
                          <Download className="h-3.5 w-3.5" />
                          Download thalamus-installer.exe (v4.3.0)
