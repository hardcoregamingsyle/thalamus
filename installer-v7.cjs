...
const PORT = 7891;
const INSTALLER_VERSION = "7.0.3";

// ── URLs ──────────────────────────────────────────────────────────────────────
const DESKTOP_APP_URL = "https://github.com/hardcoregamingsyle/thalamus/releases/download/desktop-v1.0.2/Thalamus-Desktop-v1.0.2-win64.zip";
